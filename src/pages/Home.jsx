...
export default function Home () {
  ...
  // const [isOpen, setIsOpen] = useState(false) // Modal ochish yoki yopish
    ...
    <div className='relative'>
      ...
      <div className='max-w-screen-xl mx-auto'>
        ...
        <div>
          {/* Chat butoni */}
          <button
            onClick={() => setIsOpen(true)} // Modalni ochish
            className={`fixed bottom-4 right-9 bg-blue-500 text-white p-4 rounded-full ${
              unreadMessages > 0 ? 'bg-red-500' : ''
            }`} // Qizil bo'ladi, agar xabarlar kelgan bo'lsa
          >
            <svg
              xmlns='http://www.w3.org/2000/svg'
              width='40'
